  ...
  >
    <el-form ref="form" :model="editDetails" :rules="rules" label-position="right" label-width="125px">
      ...
      <el-form-item label="币种图标">
        ...
        <img v-if="editDetails.icon" :src="imgUrl+editDetails.icon" alt=""
             style="width: 56px;height: 56px;margin-top: 10px;">
        <p style="font-size: 12px;color: red;">图片尺寸56px*56px</p>
      </el-form-item>
...
<script>
    import { addCoin, updateCoin, updataFile, getCoinList,getImgUrl  } from '@/api/index';
        ...
        methods: {
            ...
            beforeUpload(file) {
                ...
                updataFile(fd).then(response => {
                    ...
                    console.log(this.editDetails.icon)
                }).catch(err => {
                    // this.$message({
                    //     message: '系统错误',
                    //     type: 'error'
