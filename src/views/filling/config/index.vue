      ...
      <el-table-column label="操作" align="center" min-width="150px" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          <el-tooltip class="item" effect="dark" content="修改" placement="top">
            <i v-hasPermission="['sysConfig:update']" class="el-icon-setting table-operation" style="color: #2db7f5;"
               @click="edit(row)"/>
          </el-tooltip>
          <el-link v-has-no-permission="['sysConfig:update']" class="no-perm">
            无权限
          </el-link>
        </template>
      </el-table-column>
...
<script>
    ...
    import { getFconfig } from '@/api/index';
    ...
    export default {
        ...
        methods: {
            ...
            fetch(params = {}) {
                ...
                this.loading = true;
                getFconfig(params).then(response => {
                    this.loading = false;
