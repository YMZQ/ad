<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="币种图片" :show-overflow-tooltip="true" align="center" min-width="120px">
        <template slot-scope="scope">
          <img :src="scope.row.coinImg" alt="">
        </template>
      </el-table-column>
      <el-table-column label="PC简介" :show-overflow-tooltip="true" align="center" min-width="120px">
        <template slot-scope="scope">
          <span>{{ scope.row.remark }}</span>
        </template>
      </el-table-column>
      <el-table-column label="APP简介" :show-overflow-tooltip="true" align="center" min-width="120px">
        <template slot-scope="scope">
          <span>{{ scope.row.remark }}</span>
        </template>
      </el-table-column>
