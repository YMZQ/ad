<template>
  ...
  >
    <el-form ref="form" :model="editDetails" :rules="rules" label-position="right" label-width="125px">
          <el-form-item label="币种名称" prop="google">
            <el-input v-model.number="editDetails.google"/>
          </el-form-item>
          <el-form-item label="送币数量" prop="google">
            <el-input v-model.number="editDetails.google"/>
          </el-form-item>
          <el-form-item label="推荐人送币数量" prop="google">
            <el-input v-model.number="editDetails.google"/>
          </el-form-item>
          <el-form-item label="送币总数" prop="google">
            <el-input v-model.number="editDetails.google"/>
          </el-form-item>
          <el-form-item label="是否开启" prop="vipLevel">
          ...
          <el-form-item label="开始时间" prop="google">
            <el-date-picker type="date" placeholder="选择日期" v-model="editDetails.google"></el-date-picker>
          </el-form-item>
